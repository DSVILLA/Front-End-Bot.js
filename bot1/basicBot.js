...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://cdn.jsdelivr.net/gh/DSVILLA/BotDS/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://cdn.jsdelivr.net/gh/DSVILLA/BotDS/bot1/basicBot.js",
        cmdLink: "http://git.io/245Ppg",
        chatLink: "https://cdn.jsdelivr.net/gh/DSVILLA/BotDS/lang/pt.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            lockskipPosition: 3,
            lockskipReasons: [
                ["theme", "Pai você não tem poder aqui by: bot malandraum. "],
                ["op", "Esse video é repetido de mais. "],
                ["history", "Esse video está no historico. "],
                ["mix", "You played a mix, which is against the rules. "],
                ["sound", "The song you played had bad sound quality or no sound. "],
                ["nsfw", "Esse video tem /NSFW, é proibido (imagem). "],
                ["unavailable", "Esse video está com falha. "]
            ],
            ball: [
            "Acho que sim pai de familia.",
            "Sim seu viadown.",
            "Nem vou te responder.",
            "Se você souber fazer o dible da pandora.",
            "Minhas fontes dizem que não pai de familia.",
            "Pelo que eu vejo, sim.",
            "Depende .",
            "I se for ? palhaço .",
            "Dependendo da perspectiva não.",
            "Isso está decidido já porra.",
            "Melhor não te contar agr.",
            "Bem duvidoso carai.",
            "Sim - definitivamente porra.",
            "Isso é certo seu cuzão.",
            "Não posso te contar agora.",
            "Provavelmente carai.",
            "Respondo a hora que eu quiser.",
            "Minha resposta é não.",
            "Parece bom .",
            "Melhor não contar com isso heim carai.",
            "Sim,.",
            "Minhas fontes dizem que ele é um viadown.",
            "Definitivamente não carai.",
            "Você tem que compra uma caixa de pandora, para saber.",
            "Eu ainda tenho minhas duvidas, mas vai saber.",
            "Parece que sim viadown.",
            "Parece legal para mim!",
            "Quem sabe?",
            "Parece legal!",
            "Provavelmente.",
            "Cê tá viajando viadão ??",
            "Já mandei toma no cú,não vou responder .",
            "Esqueça isso pai de familia."
            ],
            afkpositionCheck: 15,
